# -*- coding: utf-8 -*-
"""pipeline_npz_iterative_signals_v3.py

Итеративная полностью автоматическая калибровка по NPZ (v2):

v3 добавляет к v2 ещё одну инженерно‑практичную вещь:
...
Запуск:
python calibration/pipeline_npz_iterative_signals_v3.py --osc_dir <OSC_DIR> --iters 2 --param_staging auto --staging_only_final
