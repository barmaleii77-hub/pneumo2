# -*- coding: utf-8 -*-
"""pipeline_npz_autopilot_v12.py

Autopilot "всё автоматически" для калибровки по NPZ + multiobjective.

v11 — surrogate global init + multi-fidelity coarse-to-fine усиление для многопараметрических задач:
...
python calibration/pipeline_npz_autopilot_v12.py --osc_dir <OSC_DIR> --run_oed --run_profile_auto --run_plots --run_pareto --run_epsilon
...
def main():
    ...
    if args.out_dir:
        ...
        out_dir = project_root / "calibration_runs" / f"RUN_{ts}_autopilot_v12"
