...
- Autopilot переключён на `pipeline_npz_group_balance_v2.py`.
...
def main():
    ...
    if args.run_group_balance and _budget_ok():
        cmd_gb = [
            sys.executable, str(project_root / "calibration" / "pipeline_npz_group_balance_v2.py"),
            "--osc_dir", str(osc_dir),
            "--signals_csv", str(final_signals),
            ...
            "--tol_max_improve", str(float(args.group_balance_tol_max_improve)),
