...
python calibration/pipeline_npz_autopilot_v3.py --osc_dir <OSC_DIR> --run_oed --run_profile_auto --run_plots

Выход: calibration_runs/RUN_..._autopilot_v3/
...
def main():
    ...
    if args.out_dir:
        ...
        out_dir = project_root / "calibration_runs" / f"RUN_{ts}_autopilot_v3"
    ...
    # summary
    summary = []
    summary.append("# Autopilot v3 summary\n")
    ...
    print("\nDONE. Autopilot v3 outputs in:", out_dir)
