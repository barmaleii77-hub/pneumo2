...
python calibration/pipeline_npz_autopilot_v15.py --osc_dir <OSC_DIR> --run_oed --run_profile_auto --run_plots --run_pareto --run_epsilon

Выход: calibration_runs/RUN_..._autopilot_v15/
...
def main():
    ...
    if args.out_dir:
        ...
        out_dir = project_root / "calibration_runs" / f"RUN_{ts}_autopilot_v15"
