...
python calibration/pipeline_npz_autopilot_v5.py --osc_dir <OSC_DIR> --run_oed --run_profile_auto --run_plots
...
def main():
    ...
    # summary
    summary = []
    summary.append("# Autopilot v5 summary\n")
    ...
    print("\nDONE. Autopilot v5 outputs in:", out_dir)
