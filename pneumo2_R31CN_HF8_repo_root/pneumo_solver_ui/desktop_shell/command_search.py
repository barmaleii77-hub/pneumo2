...
def build_shell_command_search_entries(
    ...
    entries: list[ShellCommandSearchEntry] = [
        ShellCommandSearchEntry(
            ...
            summary="Открывает панель проекта с основным порядком работы и быстрыми переходами.",
            action_kind="home",
            action_value="home",
        ...
        ShellCommandSearchEntry(
            label="Проверить проект и подготовить архив",
            location="Главное окно / Быстрые действия",
            summary="Открывает проверку проекта и подготовку архива для отправки.",
            action_kind="tool",
            action_value="desktop_diagnostics_center",
            keywords=("проверка проекта", "архив для отправки", "отправка", "состояние", "готовность"),
        ),
        ShellCommandSearchEntry(
            label="Открыть аниматор",
            location="Главное окно / Быстрые действия",
            summary="Открывает аниматор для результатов расчёта и текущих настроек.",
            action_kind="tool",
