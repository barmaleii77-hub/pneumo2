...
def build_shell_command_search_entries(
    ...
    entries: list[ShellCommandSearchEntry] = [
        ShellCommandSearchEntry(
            ...
            location="Рабочее место / Панель проекта",
        ...
        ShellCommandSearchEntry(
            label="Перейти к списку рабочих окон",
            location="Рабочее место / Список рабочих окон",
        ...
        ShellCommandSearchEntry(
            label="Проверить проект и сохранить архив",
            location="Рабочее место / Быстрые действия",
            summary="Показывает проверку проекта и сохранение архива проекта.",
            action_kind="tool",
            action_value="desktop_diagnostics_center",
            keywords=("проверка проекта", "архив проекта", "сохранить архив", "состояние", "готовность"),
        ),
        ShellCommandSearchEntry(
            label="Анимировать результат",
            location="Рабочее место / Быстрые действия",
            summary="Переходит к аниматору для результатов расчёта и текущих настроек.",
            action_kind="tool",
        ...
        ShellCommandSearchEntry(
            ...
            summary="Открывает описание результатов расчёта, которые будет использовать аниматор.",
        ...
        ShellCommandSearchEntry(
            ...
            location="Анимация / Подготовка",
            summary="Открывает проверку готовности результатов расчёта для окна анимации.",
            action_kind="open_artifact",
            action_value="animator.animator_link_contract",
            keywords=("связь с аниматором", "подготовка анимации", "результаты расчёта"),
        ),
        ShellCommandSearchEntry(
            label="Открыть результаты расчёта",
            location="Анимация / Результаты расчёта",
            summary="Открывает файл результатов расчёта, который будет загружен в аниматор.",
            action_kind="open_artifact",
        ...
        ShellCommandSearchEntry(
            label="Открыть описание сохранённой анимации",
            location="Анимация / Сохранение",
            summary="Открывает описание сохранённой анимации: где лежит файл и какие данные были использованы.",
            action_kind="open_artifact",
            action_value="animator.capture_export_manifest",
            keywords=(
                "сохранение анимации",
                "описание сохранённой анимации",
                "запись сохранения",
        ...
        ShellCommandSearchEntry(
            ...
            location="Рабочее место / Быстрые действия",
            summary="Переходит к сравнению результатов.",
            action_kind="tool",
