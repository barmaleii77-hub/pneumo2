...
def build_shell_command_search_entries(
    ...
    entries: list[ShellCommandSearchEntry] = [
        ...
        ShellCommandSearchEntry(
            label="Перейти к дереву проекта",
            location="Рабочее место / Дерево проекта",
            summary="Переводит фокус в левое дерево проекта, порядка работы и рабочих поверхностей.",
            action_kind="focus",
        ...
        ShellCommandSearchEntry(
            ...
            summary="Открывает диагностику проекта и сохранение архива проекта.",
            action_kind="tool",
