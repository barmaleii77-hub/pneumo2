...
def build_spec() -> DesktopShellToolSpec:
    return DesktopShellToolSpec(
        ...
        title="Диагностика",
        description="Единый центр проверки окружения, сборки архива диагностики и подготовки материалов к отправке.",
        ...
        details="Сводит диагностику, сбор диагностических архивов и подготовку отправки в один центр без рассыпания по нескольким экранам.",
        menu_order=140,
        nav_order=140,
