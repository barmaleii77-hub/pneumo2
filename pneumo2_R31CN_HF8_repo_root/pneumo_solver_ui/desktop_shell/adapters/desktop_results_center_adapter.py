...
def build_spec() -> DesktopShellToolSpec:
    return DesktopShellToolSpec(
        ...
        description="Окно результатов, проверки расчёта и переходов к сравнению, визуализации и проверке проекта.",
        ...
        details="Здесь пользователь видит, что именно считалось, какие замечания нашлись, какой следующий шаг рекомендован и как перейти к сравнению, аниматору и проверке проекта.",
        menu_order=50,
        nav_order=50,
        primary=True,
