...
def build_spec() -> DesktopShellToolSpec:
    return DesktopShellToolSpec(
        ...
        description=(
            "Редактирование циклического сценария, проверка покрытия "
        ...
        details=(
            ...
            "шага. Здесь пользователь правит сегменты, дорожные профили и манёвры, проверяет "
            "покрытие и передаёт согласованный набор в раздел испытаний."
        ),
        menu_order=20,
        nav_order=20,
        primary=True,
