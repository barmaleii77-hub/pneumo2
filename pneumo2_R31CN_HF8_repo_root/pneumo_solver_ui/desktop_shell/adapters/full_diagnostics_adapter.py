...
def build_spec() -> DesktopShellToolSpec:
    return DesktopShellToolSpec(
        ...
        description="Проверка диагностических пакетов, прогонов и сборки расширенной технической информации.",
        group="Встроенные окна",
        mode="hosted",
        menu_section="Инструменты",
        nav_section="Инструменты",
        details="Служебный диагностический раздел для углублённого разбора состояния проекта и артефактов.",
        menu_order=140,
        nav_order=140,
