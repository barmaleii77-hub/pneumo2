...
class DesktopDiagnosticsBundleRecord:
    ...
    latest_integrity_status: str = "MISSING"
    latest_integrity_final_zip_sha256: str = ""
    latest_integrity_final_original_zip_sha256: str = ""
    latest_integrity_sha_sidecar_matches: Optional[bool] = None
    latest_integrity_pointer_matches_original: Optional[bool] = None
    latest_integrity_latest_zip_matches_original: Optional[bool] = None
    latest_integrity_evidence_sidecar_path: str = ""
    latest_integrity_embedded_manifest_zip_sha256: str = ""
    latest_integrity_embedded_manifest_zip_sha256_scope: str = ""
    latest_integrity_embedded_manifest_stage: str = ""
    latest_integrity_embedded_manifest_finalization_stage: str = ""
    latest_integrity_trigger: str = ""
    latest_integrity_collection_mode: str = ""
    latest_integrity_producer_warning_count: int = 0
    latest_integrity_warning_only_gaps_present: bool = False
    latest_integrity_no_release_closure_claim: bool = True
    latest_integrity_warnings: list[str] = field(default_factory=list)
    self_check_silent_warnings_status: str = "MISSING"
    self_check_silent_warnings_json_path: str = ""
    self_check_silent_warnings_md_path: str = ""
    self_check_silent_warnings_rc: Optional[int] = None
    self_check_silent_warnings_fail_count: int = 0
    self_check_silent_warnings_warn_count: int = 0
    self_check_silent_warnings_snapshot_only: bool = True
