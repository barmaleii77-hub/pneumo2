# ORIGINAL_FILENAME: 03_Советник_по_конструкции.py
# -*- coding: utf-8 -*-
...
safe_set_page_config(page_title="Design Advisor", layout="wide")
st.title("Design Advisor — автоматический анализ узких мест")
...
dt = st.number_input("dt", value=0.001, format="%.6f")
t_end = st.number_input("t_end", value=2.0, format="%.3f")
