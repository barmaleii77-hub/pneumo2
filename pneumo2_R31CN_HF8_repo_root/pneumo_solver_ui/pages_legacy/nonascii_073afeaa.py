# ORIGINAL_FILENAME: 07_Сравнение_NPZ_QT.py
# -*- coding: utf-8 -*-
...
safe_set_page_config(page_title="Сравнение прогонов (Qt)", layout="wide")
...
st.markdown(
    ...
    **Как пользоваться:**
    ...
    Если Qt/зависимости не установлены — установите их на странице **Установка и диагностика** (одна кнопка) и попробуйте снова.
    """
)
