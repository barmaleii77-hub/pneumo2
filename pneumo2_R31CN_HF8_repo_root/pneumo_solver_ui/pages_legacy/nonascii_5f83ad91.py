# ORIGINAL_FILENAME: 00_Установка_и_диагностика.py
# -*- coding: utf-8 -*-
"""00_Установка_и_диагностика.py — Установка и диагностика (Streamlit)
...
def main() -> None:
    safe_set_page_config(page_title="Установка и диагностика", layout="wide")

    st.title("🧰 Установка и диагностика")
