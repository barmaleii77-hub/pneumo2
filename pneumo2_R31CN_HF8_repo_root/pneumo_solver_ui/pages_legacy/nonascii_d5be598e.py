# ORIGINAL_FILENAME: 01_╨ª╨╡╨╗╨╛╤ü╤é╨╜╨╛╤ü╤é╤î_╤ü╤à╨╡╨╝╤ï.py
# -*- coding: utf-8 -*-
...
def main() -> None:
    safe_set_page_config(page_title="Целостность схемы", layout="wide")
