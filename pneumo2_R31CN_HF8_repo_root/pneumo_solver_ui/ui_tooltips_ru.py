...
HELP_BY_KEY: Dict[str, str] = {
    ...
    "ui_suite_preset": "Быстрый выбор шаблона набора сценариев.",
    "ui_suite_stage_filter": "Фильтр сценариев по стадиям.",
    "ui_suite_only_enabled": "Показывать только включённые сценарии.",
    "ui_suite_search": "Поиск по имени и типу сценария.",
    ...
    "opt_autoupdate_baseline": "Если найден кандидат лучше текущего опорного прогона — сохранить его как новый старт в workspace/baselines/baseline_best.json.",
}
# Подсказки по префиксу key (покрывает много виджетов без ручного перечисления).
HELP_BY_KEY_PREFIX: Dict[str, str] = {
    "ui_scen_": "Генератор сценариев: настройка дороги/манёвров. Нажмите «Сгенерировать и добавить», чтобы создать CSV и сценарий.",
    ...
    "oneclick_": "Пакетный калибровочный прогон: подготовка NPZ и запуск калибровочных пайплайнов без ручной консоли.",
    ...
    "osc_": "OSC/логи: папка и файлы для сопоставления сценариев с измерениями (калибровка).",
...
HELP_BY_LABEL: Dict[str, str] = {
    "Запустить baseline": "Считает выбранные сценарии на текущих параметрах и показывает сводную таблицу.",
    "Запустить опорный прогон": "Считает выбранные сценарии на текущих параметрах и показывает сводную таблицу.",
    "Запустить оптимизацию": "Запускает подбор параметров в фоне. Перед запуском убедитесь, что набор сценариев и диапазоны корректны.",
    ...
    "Включить все": "Включить все сценарии в наборе (enabled=True). Убедитесь, что длительные сценарии не включены случайно.",
    "Выключить все": "Выключить все сценарии (enabled=False). Полезно, чтобы включить только нужные вручную.",
    "Дублировать выбранный": "Создать копию выбранного сценария (можно быстро сделать несколько вариантов dt/t_end).",
    "Удалить выбранный": "Удалить выбранный сценарий из таблицы. Действие необратимо (если нужно — сначала скачайте CSV/JSON).",
    "Сгенерировать и добавить": "Создать CSV дороги/манёвра по заданным параметрам и добавить новый сценарий в таблицу набора.",
}
