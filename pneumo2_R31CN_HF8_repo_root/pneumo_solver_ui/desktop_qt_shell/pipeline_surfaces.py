...
V38_PIPELINE_SURFACES: tuple[ShellPipelineSurface, ...] = (
    ...
    ShellPipelineSurface(
        ...
        handoff_label="Готовит сведения о визуализации для проверки проекта",
    ...
    ShellPipelineSurface(
        ...
        purpose="Проверка файлов проекта, сохранение архива проекта и понятный отчёт о готовности.",
        source_label="Результаты анализа, анимации и проверка готовности файлов",
        next_action="Проверить проект или сохранить архив проекта.",
        handoff_label="Архив проекта и отчёт проверки",
        search_aliases=("проверка проекта", "архив проекта", "сохранить архив", "проверка готовности"),
    ),
)
...
OPERATOR_FORBIDDEN_LABELS: tuple[str, ...] = (
    ...
    "Маршрут проекта",
    (
        "Открыть резервное старое "
        "окно"
    ),
    (
        "Открыть резервное главное "
        "окно"
    ),
