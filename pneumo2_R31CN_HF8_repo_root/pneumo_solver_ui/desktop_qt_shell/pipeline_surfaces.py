...
V38_PIPELINE_SURFACES: tuple[ShellPipelineSurface, ...] = (
    ...
    ShellPipelineSurface(
        ...
        purpose="Диагностика файлов проекта, сохранение архива проекта и понятный отчёт о готовности.",
        source_label="Результаты анализа, анимации и диагностика готовности файлов",
        next_action="Собрать диагностику и сохранить архив проекта.",
        handoff_label="Архив проекта и отчёт диагностики",
        search_aliases=(
            "диагностика",
            "собрать диагностику",
            "проверка проекта",
