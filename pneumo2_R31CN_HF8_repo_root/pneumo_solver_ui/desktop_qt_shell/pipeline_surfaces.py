...
V38_PIPELINE_SURFACES: tuple[ShellPipelineSurface, ...] = (
    ...
    ShellPipelineSurface(
        ...
        search_aliases=("ввод", "параметры", "геометрия", "пневматика"),
    ),
    ShellPipelineSurface(
        key="ws_ring",
    ...
    ShellPipelineSurface(
        ...
        purpose="Целевая функция, ограничения качества, метка прогона и один активный режим оптимизации.",
        ...
        search_aliases=("оптимизация", "локальный запуск", "параллельный запуск", "цели расчёта"),
    ),
    ShellPipelineSurface(
        key="ws_analysis",
    ...
    ShellPipelineSurface(
        ...
        search_aliases=("диагностика", "архив диагностики", "отправка результатов", "проверка готовности"),
    ),
)
