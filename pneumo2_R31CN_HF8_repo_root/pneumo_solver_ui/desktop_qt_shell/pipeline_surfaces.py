...
V38_PIPELINE_SURFACES: tuple[ShellPipelineSurface, ...] = (
    ShellPipelineSurface(
        ...
        tool_key=None,
        purpose="Сводка проекта, готовность рабочих артефактов и ближайший инженерный шаг.",
        source_label="Текущий проект и выбранная рабочая папка",
        next_action="Перейти к исходным данным или выбрать нужный раздел в дереве.",
        handoff_label="Старт маршрута",
    ...
    ShellPipelineSurface(
        ...
        handoff_label="Сохраняет снимок исходных данных для сценариев и набора испытаний",
    ...
    ShellPipelineSurface(
        ...
        handoff_label="Передаёт проверенный набор файлов в набор испытаний",
    ...
    ShellPipelineSurface(
        ...
        next_action="Проверить включение тестов, этапы, приоритеты, dt и t_end.",
        handoff_label="Создаёт проверенный набор испытаний для базового прогона",
        search_aliases=("suite", "test matrix", "набор испытаний", "validated suite"),
    ),
    ShellPipelineSurface(
        key="ws_baseline",
        ...
        handoff_label="Передаёт выбранный базовый прогон в оптимизацию",
    ...
    ShellPipelineSurface(
        ...
        handoff_label="Передаёт выбранный прогон в анализ",
    ...
    ShellPipelineSurface(
        ...
        next_action="Выбрать прогон, сравнить результаты и подготовить контекст анимации.",
        handoff_label="Передаёт контекст анализа и перечень подтверждающих артефактов",
    ...
    ShellPipelineSurface(
        ...
        source_label="Контекст анализа и ссылки на артефакты",
        next_action="Запускать анимацию только после выбора результата анализа.",
        handoff_label="Передаёт сведения о подготовленном снимке в диагностику",
    ...
    ShellPipelineSurface(
        ...
        purpose="Проверка проекта, диагностический архив SEND и отчёт о состоянии.",
        source_label="Результаты анализа, анимации и проверки выполнения",
        next_action="Собрать диагностику или проверить готовность bundle.",
        handoff_label="Финальный архив SEND и отчёт о состоянии",
