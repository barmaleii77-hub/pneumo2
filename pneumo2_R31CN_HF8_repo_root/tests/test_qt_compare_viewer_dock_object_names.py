...
def test_qt_compare_viewer_all_persistent_docks_have_object_names() -> None:
    ...
    assert 'dock.setObjectName("dock_compare_contract")' in src
    assert 'dock.setObjectName("dock_deltat_heatmap")' in src
    assert 'dock.setObjectName("dock_peak_heatmap")' in src
    assert 'dock.setObjectName("dock_open_timeline")' in src
    assert 'dock.setObjectName("dock_influence_heatmap")' in src
    assert 'dock.setObjectName("DockInfluenceT")' in src
    assert 'dock.setObjectName("dock_run_metrics")' in src
    assert 'dock.setObjectName("dock_static_stroke")' in src
    ...
    assert 'dock.setObjectName("dock_geometry_acceptance")' in src
    assert "self.restoreState(win_state)" in src
