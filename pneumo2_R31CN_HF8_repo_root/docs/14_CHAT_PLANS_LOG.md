...
51. Diagnostics GUI cleanup
Назначение: Закрепить в Desktop Diagnostics Center общий верхний блок Текущий процесс с progressbar для диагностики и сборки ZIP; русифицировать операторские статусы/сводки/кнопки; обновить контрактные тесты, запрещающие возврат английских UI-строк и скрытого прогресса.
Статус: done.
