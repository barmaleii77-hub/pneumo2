...
23. Приёмка и уборка результатов 10 параллельных GUI-чатов
Работа 10 V38-направлений должна приниматься в codex/work через интеграционный коммит/merge-коммиты, с проверкой отсутствия служебных UI-формулировок, сохранением полезных изменений из dirty worktree и последующей уборкой временных worktree/веток.
Статус: active.
Источник: chat:2026-04-18 accept 10 chats cleanup.
ID: `REQ-0023`.

24. Diagnostics GUI: видимый прогресс и русский операторский текст
Окно диагностики должно быть простым и последовательным: любые длительные действия показывают прогресс в общей видимой зоне того же окна независимо от выбранной вкладки; пользовательские подписи, статусы и сообщения должны быть на русском; английские технические ключи допустимы только в машинно-читаемых JSON/log артефактах и не должны вытекать в операторский интерфейс.
Статус: active.
Источник: chat:2026-04-18 diagnostics gui complaint.
ID: `REQ-0024`.

25. GUI-кнопки и надписи должны смыслово соответствовать V38 и оптимизированному пользовательскому pipeline
Все operator-facing кнопки, заголовки, статусы, подсказки и диалоги desktop GUI должны вести пользователя по графу PIPELINE_OPTIMIZED.dot без лишних этапов, без service-jargon leaks, без английских служебных терминов и без подмены доменной логики. Animator, Desktop Mnemo и Compare Viewer не являются запрещёнными зонами: их можно развивать, но нельзя ломать рабочее поведение и нельзя дублировать их ответственность в чужих окнах.
Статус: active.
