...
- `docs/gui_chat_prompts/16_RECOVERY_PLAN_MODE_START_PROMPTS.md` — current post-quarantine self-contained Plan-mode starter prompts for the same 10 chats after branch/tree recovery and `7823dc2` integration.
...
- Для новых parallel-chat starts после recovery-pass и `7823dc2` resolution сначала сверять `docs/context/release_readiness/BRANCH_TREE_RECOVERY_AUDIT_2026-04-18.md`, `docs/context/release_readiness/QUARANTINE_7823DC2_RESOLUTION_2026-04-18.md` и использовать `docs/gui_chat_prompts/16_RECOVERY_PLAN_MODE_START_PROMPTS.md`; resolved quarantine branch не является рабочим источником.
