...
- Слой уточняет GUI/TZ knowledge base, но не заменяет абсолютный закон,
  parameter registry, data contract и human-readable canon `17/18`.
...
5. `RELEASE_GATE_HARDENING_MATRIX.csv`
6. `RUNTIME_ARTIFACT_SCHEMA.yaml`
7. `EVIDENCE_REQUIRED_BY_GATE.csv`
8. `GAP_TO_EVIDENCE_ACTION_MAP.csv`
