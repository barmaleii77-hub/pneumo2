...
| `docs/context/gui_spec_imports/v32_connector_reconciled/COMPARE_OBJECTIVE_INTEGRITY_EVIDENCE_NOTE.md` | keep | V32-08/V32-06/V32-16 | PB-007 PB-008 RGH-013 RGH-014 RGH-015 | Compare/objective integrity evidence note with no runtime closure claim | `tests/test_qt_compare_viewer_compare_contract.py; tests/test_optimization_objective_contract.py; tests/test_r31cw_optimization_run_history_objective_contract.py` | Keep compare/objective evidence note as lane integration proof. |
