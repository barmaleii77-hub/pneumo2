...
| `docs/context/gui_spec_imports/v32_connector_reconciled/DIAGNOSTICS_RELEASE_EVIDENCE_NOTE.md` | needs-review | V32-11/V32-16 | RGH-006 RGH-016 OG-005 | Diagnostics evidence note with bundle paths | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review with diagnostics lane evidence package. |
...
| `pneumo_solver_ui/browser_perf_artifacts.py` | needs-review | V32-15 | RGH-011 RGH-012 RGH-019 OG-003 OG-004 | measured trace artifact | `tests/test_r31bu_browser_perf_artifacts.py` | Review as runtime evidence draft. |
...
| `pneumo_solver_ui/components/playhead_ctrl/index.html` | needs-review | V32-15/V32-09 | RGH-019 OG-003 | frame cadence evidence | `tests/test_r78_animator_playback_speed_stability.py` | Review browser component impact. |
...
| `pneumo_solver_ui/desktop_diagnostics_model.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | diagnostics evidence manifest | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review diagnostics model draft. |
| `pneumo_solver_ui/desktop_diagnostics_runtime.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | diagnostics evidence manifest | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review diagnostics runtime draft. |
...
| `pneumo_solver_ui/diagnostics_entrypoint.py` | needs-review | V32-11 | RGH-006 OG-005 | diagnostics latest pointer | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review diagnostics entrypoint. |
...
| `pneumo_solver_ui/release_gate.py` | needs-review | V32-16/V32-15 | RGH-011 RGH-012 RGH-019 OG-003 OG-004 | source metadata and runtime trace evidence | `tests/test_gui_spec_docs_contract.py` | Keep metadata helpers, review runtime evidence options separately. |
...
| `pneumo_solver_ui/runtime_evidence.py` | needs-review | V32-15 | RGH-011 RGH-012 RGH-019 OG-003 OG-004 | measured runtime evidence files | `tests/test_v32_runtime_evidence_gates.py` | Review new runtime evidence helper. |
...
| `pneumo_solver_ui/send_bundle.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | SEND bundle evidence manifest | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review send-bundle changes. |
| `pneumo_solver_ui/tools/desktop_diagnostics_center.py` | needs-review | V32-11 | RGH-006 OG-005 | one-click diagnostics surface | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review diagnostics center. |
...
| `pneumo_solver_ui/tools/health_report.py` | needs-review | V32-11 | RGH-006 RGH-007 OG-005 | health after final triage | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review health report changes. |
| `pneumo_solver_ui/tools/inspect_send_bundle.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | helper runtime provenance | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review inspect bundle changes. |
...
| `pneumo_solver_ui/tools/make_send_bundle.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | bundle evidence contents | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review bundle builder changes. |
| `pneumo_solver_ui/tools/postmortem_watchdog.py` | needs-review | V32-11 | RGH-006 RGH-007 OG-005 | crash/exit diagnostics evidence | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review watchdog changes. |
| `pneumo_solver_ui/tools/send_bundle_evidence.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | evidence manifest helper | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review new evidence helper. |
...
| `pneumo_solver_ui/tools/validate_send_bundle.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | bundle validation evidence | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review bundle validator changes. |
...
| `tests/test_desktop_diagnostics_center_contract.py` | needs-review | V32-11 | RGH-006 OG-005 | diagnostics center contract test | `tests/test_desktop_diagnostics_center_contract.py` | Review diagnostics center tests. |
...
| `tests/test_health_report_inspect_send_bundle_anim_diagnostics.py` | needs-review | V32-11/V32-09 | RGH-006 RGH-016 RGH-019 OG-005 | health/send-bundle/anim diagnostics tests | `tests/test_health_report_inspect_send_bundle_anim_diagnostics.py` | Review diagnostics regression changes. |
...
| `tests/test_r31bu_browser_perf_artifacts.py` | needs-review | V32-15 | RGH-011 OG-003 | browser perf artifact tests | `tests/test_r31bu_browser_perf_artifacts.py` | Review perf tests. |
...
| `tests/test_r42_bundle_stable_road_grid_and_aux_cadence_metrics.py` | needs-review | V32-11/V32-15 | RGH-006 RGH-019 | bundle cadence evidence tests | `tests/test_r42_bundle_stable_road_grid_and_aux_cadence_metrics.py` | Review cadence tests. |
...
| `tests/test_r78_animator_playback_speed_stability.py` | needs-review | V32-09/V32-15 | RGH-019 OG-003 | animator frame cadence tests | `tests/test_r78_animator_playback_speed_stability.py` | Review playback stability tests. |
...
| `tests/test_v32_diagnostics_send_bundle_evidence.py` | needs-review | V32-11 | RGH-006 RGH-016 OG-005 | diagnostics evidence tests | `tests/test_v32_diagnostics_send_bundle_evidence.py` | Review new diagnostics evidence tests. |
| `tests/test_v32_runtime_evidence_gates.py` | needs-review | V32-15 | RGH-011 RGH-012 RGH-019 OG-003 OG-004 | runtime evidence gate tests | `tests/test_v32_runtime_evidence_gates.py` | Review new runtime evidence tests. |
